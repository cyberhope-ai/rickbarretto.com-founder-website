export default function ThePattern() {
  const examples = [
    ...
    },
    {
      ...
      uses: [
        "PrecognitionOS — 11-layer AI governance OS, 11 agents 24/7",
        "Prosperity Signal Marketplace — EURUSD Sharpe 3.221, MaxDD 0.36%",
        "QSurface — cryptographic signal timestamping before execution",
        "Helix Swarm Fabric — decentralized AI compute (29 GPUs)",
        "SkillDNA — cognitive profiling protocol",
        "30-patent portfolio strategy across 5 IP categories",
