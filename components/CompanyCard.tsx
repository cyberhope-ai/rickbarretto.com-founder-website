      ...
      <div className="p-6 md:p-8 flex gap-5 md:gap-6 items-start">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-2">
            <span
              {/* MED-3 fix: text-[10px]→text-[11px], py-0.5→py-1 for taller badge tap target */}
              className={`text-[11px] font-semibold uppercase tracking-wider px-2 py-1 rounded-full border ${statusColors[c.status]}`}
            >
            ...
            {c.firstInCategory && (
              {/* MED-3 fix: text-[10px]→text-[11px], py-0.5→py-1 */}
              <span className="text-[11px] font-semibold uppercase tracking-wider px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 border border-yellow-200">
                ★ First in Category
              </span>
            )}
          </div>
